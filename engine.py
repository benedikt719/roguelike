...
def main():
    ...
    fighter_components = Fighter(hp=30,defense=2,power=5)
    player = Entity(0,0,'@', (255,255,255),'player',blocks = True,fighter=fighter_components)
    entities = [player]
    ...
    game_states = GameStates.PLAYERS_TURN
    ...
    while not tdl.event.is_window_closed():
        ...
        if move and game_states == GameStates.PLAYERS_TURN:
            dx, dy = move
            ...
            if game_map.walkable[destination_x,destination_y]:
                ...
                game_states = GameStates.ENEMY_TURN
        ...
        if game_states == GameStates.ENEMY_TURN:
